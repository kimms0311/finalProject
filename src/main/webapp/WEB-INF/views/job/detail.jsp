...
<div class="bodyContainer">
	...
	<div class="jobInfoSecction">
		<p><strong><i class="bi bi-coin"></i>${pbvo.proMenu}
		<fmt:formatNumber type="number" maxFractionDigits="3" value="${pbvo.proPrice}" />원</p></strong>
		...
		<div class="jobInfoDetail">
			...
			<p>
			조회수 ${pbvo.proReadCnt} <a href="/job/like?pbno=${pbvo.proBno}"><i class="bi bi-heart"></i>찜하기 ${pbvo.proLikeCnt}</a>
			</p>
		</div>
...
<script type="text/javascript">
    ...
    console.log("본문내에서 불러오는거 DETAIL jobAddress>>" + jobAddress);
